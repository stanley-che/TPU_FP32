// tb_attention_score_top.sv
// ------------------------------------------------------------
// iverilog -g2012 -Wall -I./src -o ./vvp/tb_att.vvp ./test/tb_attention_score_top.sv
//   
// vvp ./vvp/tb_att.vvp
// ------------------------------------------------------------
...
endtask
  ...
  initial begin
    ...
    // start FSM (hold start 1 cycle then drop; FSM requires drop to re-arm)
